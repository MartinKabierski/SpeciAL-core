...
log = pm4py.read_xes("../../logs/BPI_Challenge_2019.xes", return_legacy_log_object=True)

print("###1###")
mod, i, f = pm4py.discover_petri_net_alpha(log)
#print(i,f)
pm4py.save_vis_petri_net(mod, i, f, "BPI_2019_ALPHA_pm4py.pdf")
log_d_alpha = simulate_model(mod, i, f, 1, 5000)
#print(log_d_alpha[0])
profile_log(log_d_alpha[0], "log_vs_model_BPI_2019_eval_alpha_pm4py")
#print()
...
#log_d_alpha = simulate_model(mod, i, f, 1, 13087)
...
print(i,f)
pm4py.save_vis_petri_net(mod2, i, f, "BPI_2019_INDUCTIVE_infrequent_0.2_pm4py.pdf")
log_d_ind = simulate_model(mod2, i, f, 1, 5000)
profile_log(log_d_ind[0], "log_vs_model_eval_BPI_2019_inductive_infrequent_0.2_pm4py")

print("###2.2###")
mod2, i, f = pm4py.discover_petri_net_inductive(log, noise_threshold=0.4)
print(i,f)
pm4py.save_vis_petri_net(mod2, i, f, "BPI_2019_INDUCTIVE_infrequent_0.4_pm4py.pdf")
log_d_ind = simulate_model(mod2, i, f, 1, 5000)
profile_log(log_d_ind[0], "log_vs_model_eval_BPI_2019_inductive_infrequent_0.4_pm4py")


print("###2.3###")
mod2, i, f = pm4py.discover_petri_net_inductive(log, noise_threshold=0.6)
print(i,f)
pm4py.save_vis_petri_net(mod2, i, f, "BPI_2019_INDUCTIVE_infrequent_0.6_pm4py.pdf")
log_d_ind = simulate_model(mod2, i, f, 1, 5000)
profile_log(log_d_ind[0], "log_vs_model_eval_BPI_2019_inductive_infrequent_0.6_pm4py")


print("###2.4###")
mod2, i, f = pm4py.discover_petri_net_inductive(log, noise_threshold=0.8)
print(i,f)
pm4py.save_vis_petri_net(mod2, i, f, "BPI_2019_INDUCTIVE_infrequent_0.8_pm4py.pdf")
log_d_ind = simulate_model(mod2, i, f, 1, 5000)
profile_log(log_d_ind[0], "log_vs_model_eval_BPI_2019_inductive_infrequent_0.8_pm4py")

print("###2.5###")
mod2, i, f = pm4py.discover_petri_net_inductive(log, noise_threshold=0.0)
print(i,f)
pm4py.save_vis_petri_net(mod2, i, f, "BPI_2019_INDUCTIVE_0.0_pm4py.pdf")
log_d_ind = simulate_model(mod2, i, f, 1, 5000)
profile_log(log_d_ind[0], "log_vs_model_eval_BPI_2019_inductive_0.0_pm4py")

print("###3.1###")
mod3, i, f = pm4py.discover_petri_net_ilp(log, alpha=1.0)
print(i,f)
pm4py.save_vis_petri_net(mod3, i, f, "BPI_2019_ILP_1.0_pm4py.pdf")
log_d_ind2 = simulate_model(mod3, i, f, 1, 5000)
profile_log(log_d_ind2[0], "log_vs_model_eval_BPI_2019_ilp_1.0_pm4py")

print("###3.2###")
mod3, i, f = pm4py.discover_petri_net_ilp(log, alpha=0.8)
print(i,f)
pm4py.save_vis_petri_net(mod3, i, f, "BPI_2019_ILP_0.8_pm4py.pdf")
log_d_ind2 = simulate_model(mod3, i, f, 1, 5000)
profile_log(log_d_ind2[0], "log_vs_model_eval_BPI_2019_ilp_0.8_pm4py")

print("###3.2###")
mod3, i, f = pm4py.discover_petri_net_ilp(log, alpha=0.7)
print(i,f)
pm4py.save_vis_petri_net(mod3, i, f, "BPI_2019_ILP_0.7_pm4py.pdf")
log_d_ind2 = simulate_model(mod3, i, f, 1, 5000)
profile_log(log_d_ind2[0], "log_vs_model_eval_BPI_2019_ilp_0.7_pm4py")

print("###3.3###")
mod3, i, f = pm4py.discover_petri_net_ilp(log, alpha=0.6)
print(i,f)
pm4py.save_vis_petri_net(mod3, i, f, "BPI_2019_ILP_0.6_pm4py.pdf")
log_d_ind2 = simulate_model(mod3, i, f, 1, 5000)
profile_log(log_d_ind2[0], "log_vs_model_eval_BPI_2019_ilp_0.6_pm4py")

print("###3.4###")
mod3, i, f = pm4py.discover_petri_net_ilp(log, alpha=0.4)
print(i,f)
pm4py.save_vis_petri_net(mod3, i, f, "BPI_2019_ILP_0.4_pm4py.pdf")
log_d_ind2 = simulate_model(mod3, i, f, 1, 5000)
profile_log(log_d_ind2[0], "log_vs_model_eval_BPI_2019_ilp_0.4_pm4py")

print("###3.5###")
mod3, i, f = pm4py.discover_petri_net_ilp(log, alpha=0.2)
print(i,f)
pm4py.save_vis_petri_net(mod3, i, f, "BPI_2019_ILP_0.2_pm4py.pdf")
log_d_ind2 = simulate_model(mod3, i, f, 1, 5000)
profile_log(log_d_ind2[0], "log_vs_model_eval_BPI_2019_ilp_0.2_pm4py")
